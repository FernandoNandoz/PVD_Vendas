...
{
    public partial class UserControl_RemoverProduto : UserControl
    {
        #region Dll Paint
        ...
        public UserControl_RemoverProduto()
        {
            InitializeComponent();
        }
        ...
        private void UserControl_RemoverProduto_Load(object sender, EventArgs e)
        {
